...
export interface ShotVerifierInterface extends Interface {
...
export interface ShotVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): ShotVerifier;
  waitForDeployment(): Promise<this>;

  interface: ShotVerifierInterface;
