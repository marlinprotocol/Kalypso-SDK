...
export interface BoardVerifierInterface extends Interface {
...
export interface BoardVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): BoardVerifier;
  waitForDeployment(): Promise<this>;

  interface: BoardVerifierInterface;
