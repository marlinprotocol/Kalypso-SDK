...
export interface IShotVerifierInterface extends Interface {
...
export interface IShotVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): IShotVerifier;
  waitForDeployment(): Promise<this>;

  interface: IShotVerifierInterface;
