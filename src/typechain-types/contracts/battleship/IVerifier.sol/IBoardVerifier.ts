...
export interface IBoardVerifierInterface extends Interface {
...
export interface IBoardVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): IBoardVerifier;
  waitForDeployment(): Promise<this>;

  interface: IBoardVerifierInterface;
