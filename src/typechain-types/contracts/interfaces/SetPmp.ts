...
export interface SetPmpInterface extends Interface {
  getFunction(nameOrSignature: "proofMarketplace" | "setProofMarketplaceContract"): FunctionFragment;
...
export interface SetPmp extends BaseContract {
  connect(runner?: ContractRunner | null): SetPmp;
  waitForDeployment(): Promise<this>;

  interface: SetPmpInterface;
