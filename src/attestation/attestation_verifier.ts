...
class AttestationVerifier {
  ...
  public static async get_attestation(arrayBuffer: ArrayBuffer){
    ...
    const digest = this.computeDigest(attestationDecoded.publicKey,attestationDecoded.pcrs[0], attestationDecoded.pcrs[1], attestationDecoded.pcrs[2], attestationDecoded.timestamp );
