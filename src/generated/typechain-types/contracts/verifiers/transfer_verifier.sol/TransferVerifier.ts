...
export interface TransferVerifierInterface extends Interface {
...
export interface TransferVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): TransferVerifier;
  waitForDeployment(): Promise<this>;

  interface: TransferVerifierInterface;
