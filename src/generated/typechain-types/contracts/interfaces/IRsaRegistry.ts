...
export interface IRsaRegistryInterface extends Interface {
...
export interface IRsaRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): IRsaRegistry;
  waitForDeployment(): Promise<this>;

  interface: IRsaRegistryInterface;
  ...
  updatePubkey: TypedContractMethod<[rsa_pub: BytesLike, attestation_data: BytesLike], [void], "nonpayable">;
