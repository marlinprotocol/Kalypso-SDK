...
export interface I_transfer_verifierInterface extends Interface {
...
export interface I_transfer_verifier extends BaseContract {
  connect(runner?: ContractRunner | null): I_transfer_verifier;
  waitForDeployment(): Promise<this>;

  interface: I_transfer_verifierInterface;
