...
export interface GeneratorRegistryInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "minStakingAmount", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "minStakingAmount", data: BytesLike): Result;
...
export interface GeneratorRegistry extends BaseContract {
  ...
  stake: TypedContractMethod<[generatorAddress: AddressLike, amount: BigNumberish], [void], "nonpayable">;
  ...
  getFunction(nameOrSignature: "minStakingAmount"): TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(nameOrSignature: "stake"): TypedContractMethod<[generatorAddress: AddressLike, amount: BigNumberish], [void], "nonpayable">;
