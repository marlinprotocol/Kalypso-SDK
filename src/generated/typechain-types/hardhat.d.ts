...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(name: "IRsaRegistry", signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.IRsaRegistry__factory>;
    ...
    getContractAt(name: "IRsaRegistry", address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.IRsaRegistry>;
    ...
    deployContract(name: "IRsaRegistry", signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.IRsaRegistry>;
